...
/***/ function(module, exports) {
    ...
    */
    ...
    AFRAME.registerComponent('sync-url',
    {
        dependencies: ['sync'],
        schema: {
        },
        init: function () {
            ...
            function start(){
                var urlRef = sync.dataRef.child('url');
                ...
                colorRef.on('value', function (snapshot) {
                    ...
                    refChangedLocked = true;
                    component.el.setAttribute('url', url);
                    refChangedLocked = false;
    ...
    AFRAME.registerComponent('sync-time',
    {
        dependencies: ['sync'],
        schema: {
        },
        init: function () {
            ...
            function start(){
                var timeRef = sync.dataRef.child('time');
                ...
                colorRef.on('value', function (snapshot) {
                    ...
                    refChangedLocked = true;
                    component.el.setAttribute('time', time);
                    refChangedLocked = false;
