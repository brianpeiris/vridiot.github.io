...
<body>
	<a-scene altspace ='fullspace: true' debug sync-system="author: john-and-jacob; app: island">
		...
		<a-entity position="42.5 2.5 -2.9" opacity="0" n-sound="src: http://island.jacobralph.org/assets/playlist/evening/waves.<?php echo $type; ?>; volume: 0.05; autoplay: false; loop: true; minDistance: 0.1; maxDistance:20; rolloff: cosine"
