...
<body>
	...
	<a-scene altspace ='fullspace: true' debug sync-system="author: john-and-jacob; app: island">
		...
		<a-entity position="26.81583 2.7 -3.7" n-sound="src: http://island.jacobralph.org/assets/fire.ogg; autoplay: true; volume: 3; loop: true; minDistance: 0.1; maxDistance: 4; rolloff: cosine"
		altspace-cursor-collider="enabled: true" id="fire1" sync-n-sound></a-entity>
		<<a-entity position="33.16583 2.7 -8.8" n-sound="src: http://island.jacobralph.org/assets/fire.ogg; autoplay: true; volume: 3; loop: true; minDistance: 0.1; maxDistance: 4; rolloff: cosine"
		altspace-cursor-collider="enabled: true" id="fire2" sync-n-sound></a-entity>
		<a-entity position="19.06583 2.7 -4.3"  n-sound="src: http://island.jacobralph.org/assets/fire.ogg; autoplay: true; volume: 3; loop: true; minDistance: 0.1; maxDistance: 4; rolloff: cosine"
		altspace-cursor-collider="enabled: true" id="fire3" sync-n-sound></a-entity>
		<a-entity position="20.46583 2.7 -10.2"  n-sound="src: http://island.jacobralph.org/assets/fire.ogg; autoplay: true; volume: 3; loop: true; minDistance: 0.1; maxDistance: 4; rolloff: cosine"
		altspace-cursor-collider="enabled: true" id="fire4" sync-n-sound></a-entity>
		<a-entity position="8.01583 2.7 -5.18"  n-sound="src: http://island.jacobralph.org/assets/fire.ogg; autoplay: true; volume: 3; loop: true; minDistance: 0.1; maxDistance: 4; rolloff: cosine"
		altspace-cursor-collider="enabled: true" id="fire5" sync-n-sound></a-entity>
		<a-entity position="9.61583 3.15 -0.51"  n-sound="src: http://island.jacobralph.org/assets/fire.ogg; autoplay: true; volume: 3; loop: true; minDistance: 0.1; maxDistance: 4; rolloff: cosine"
		altspace-cursor-collider="enabled: true" id="fire6" sync-n-sound></a-entity>

		<a-entity position="42.5 2.5 -2.9" opacity="0" n-sound="src: http://island.jacobralph.org/assets/playlist/evening/waves.ogg; autoplay: true; volume: 0.05; loop: true; minDistance: 0.1; maxDistance:20; rolloff: cosine"
		...
		n-sound="src: http://island.jacobralph.org/assets/ocean.ogg; autoplay: true; volume: 1; loop: true; minDistance: 0.1; maxDistance: 15; rolloff: cosine"
	...
	<a-entity id="loop"
		...
		n-sound="src: http://island.jacobralph.org/assets/ocean.ogg; autoplay: true; volume: 0.2; loop: true; minDistance: 0.1; maxDistance: 15; rolloff: cosine"
		altspace-cursor-collider="enabled: true" sync-n-sound>
	</a-entity>
	...
	<a-entity id="loop"
		...
		n-sound="src: http://island.jacobralph.org/assets/ocean.ogg; autoplay: true; volume: 1; loop: true; minDistance: 0.2; maxDistance: 15; rolloff: cosine"
		altspace-cursor-collider="enabled: true" sync-n-sound>
	</a-entity>
